// Ташкент/Ереван · сверка с мастер-файлом «Меню Для макета NEW.xlsx»
// (листы «Ташкент (старый)» и «Ереван (старый)» — по решению пользователя
// используются как основа, несмотря на пометку «старый»).
//
// У этих двух точек категории в файле — смешанные рус/англ и часто в виде
// иерархии «Родитель / Ребёнок» (например «Strong alcohol / Whiskey»,
// «Авторская кухня / Горячее») — для маппинга бралась последняя часть после
// «/». Кальянные категории («Кальянная карта», «Кальяная карта / ...») —
// в раздел hookah независимо от вложенности.
//
