...
// Список специально широкий (включает морепродукты) — «с мясом»/«без мяса»
// трактуются как «животный белок», иначе ролл с угрём или гребешком
// ошибочно считался «без мяса». Расширен 2026-07-30 — реальные блюда меню
// (угорь, гребешок, краб, икра, сельдь, баранина, цыплёнок, свиная отбивная)
// не матчились исходным списком и «выпадали» из обоих фильтров сразу.
// Добавлен корень «мясн»/«мясо» — «Мясная тарелка» (composition пустой,
// в description только «ассорти мясных деликатесов») ни разу не матчилась
// конкретными видами мяса и проходила фильтр «без мяса».
const MEAT_RE =
  /говяд|телятин|свин|бекон|курин|цыпл|утк|утин|индей|баран|ягнят|кролик|ростбиф|брезаол|тартар|стейк|рибай|бургер|котлет|ветчин|карбонад|колбас|сосис|лосось|тунец|рыб|креветк|кальмар|мидии|осьминог|форель|угор|угр[её]|гребеш|краб|икр|сельд|анчоус|мясн|мясо/i;
