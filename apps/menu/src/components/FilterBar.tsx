...
const MEAT_RE =
  /говяд|телятин|свин|бекон|курин|цыпл|утк|утин|индей|баран|ягнят|кролик|ростбиф|брезаол|тартар|стейк|рибай|бургер|котлет|ветчин|карбонад|колбас|сосис|лосось|тунец|рыб|креветк|кальмар|мидии|осьминог|форель|угор|угр[её]|гребеш|краб|икр|сельд|анчоус/i;
