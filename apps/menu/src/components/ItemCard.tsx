  ...
  return (
    <article className="h-full">
      ...
      >
        ...
        {/* Контент — строго 2 строки: название + цена/кнопка */}
        <div className="flex flex-col gap-1.5 p-3 sm:p-4 pt-2.5">

          {/* Название — одна строка с многоточием.
              Полное название видно при открытии карточки блюда. */}
          <h3 className="truncate text-[13px] sm:text-[14px] font-light tracking-[0.02em] text-cream leading-snug">
            {name}
          </h3>

          {/* Цена и кнопка — строго на одной горизонтальной линии */}
          <div className="flex items-center justify-between w-full gap-2">
            <span className="text-[13px] sm:text-[14px] font-medium text-gold leading-none">
