...
const SYNONYM_GROUPS: string[][] = [
  ['паста', 'pasta', 'спагетти', 'spaghetti', 'лингвини', 'linguine', 'карбонара', 'carbonara', 'тальятелле', 'феттучини', 'fettuccine', 'болоньезе', 'bolognese', '面', '意面'],
  ['ролл', 'роллы', 'roll', 'rolls', 'суши', 'sushi', 'маки', 'maki', 'филадельфия', 'philadelphia', 'калифорния', 'california', '卷', '寿司'],
  ['пицца', 'pizza', 'маргарита', 'margherita', 'пепперони', 'pepperoni', '披萨'],
  ['бургер', 'burger', 'чизбургер', 'cheeseburger', '汉堡'],
  ['суп', 'soup', 'том ям', 'tom yam', 'tom yum', 'борщ', 'крем суп', 'харчо', 'солянка', '汤'],
  ['салат', 'salad', 'цезарь', 'caesar', 'греческий', 'greek', 'оливье', '沙拉'],
  ['стейк', 'steak', 'рибай', 'ribeye', 'миньон', 'mignon', 'говядина', 'beef', '牛排'],
  ['креветка', 'креветки', 'shrimp', 'prawn', 'tiger', 'тигровая', '虾'],
  ['лосось', 'losos', 'salmon', 'семга', 'сёмга', 'рыба', 'fish', '三文鱼', '鱼'],
  ['курица', 'chicken', 'куриный', 'цыпленок', '鸡'],
  ['десерт', 'dessert', 'тирамису', 'tiramisu', 'чизкейк', 'cheesecake', 'торт', 'cake', 'мороженое', 'ice cream', '甜点', '蛋糕'],
  ['кофе', 'coffee', 'эспрессо', 'espresso', 'капучино', 'cappuccino', 'латте', 'latte', 'американо', '咖啡'],
  ['чай', 'tea', 'улун', 'oolong', 'матча', 'matcha', '茶'],
  ['коктейль', 'cocktail', 'мохито', 'mojito', 'негрони', 'negroni', 'маргарита', 'margarita', 'апероль', 'aperol', '鸡尾酒'],
  ['лимонад', 'lemonade', 'морс', 'фреш', 'fresh', 'сок', 'juice', '柠檬水'],
  ['кальян', 'кальяны', 'hookah', 'shisha', '水烟'],
