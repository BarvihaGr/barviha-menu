...
export const ARKA_BAR_SECTIONS: ArkaMenuEntry[] = [
  ...
  { kind: 'category', sheet: "БА", category: "Молочный коктейль", items: [
    { id: "arka-bar-0008", name: "Ваниль", type: 2, priceParts: ["700"], volume: "300мл", description: "Классический ванильный" },
    { id: "arka-bar-0009", name: "Клубника", type: 2, priceParts: ["700"], volume: "300мл", description: "Свежий, ягодный" },
    { id: "arka-bar-0010", name: "Шоколад", type: 2, priceParts: ["700"], volume: "300мл", description: "Насыщенный шоколадный" },
  ] },
  ...
  { kind: 'category', sheet: "БА", category: "Вода с газом / без", items: [
    ...
    { id: "arka-bar-0016", name: "Кока-Кола", type: 2, priceParts: ["550"], volume: "330мл", description: "Освежающая классика" },
    { id: "arka-bar-0017", name: "Кока-Кола Зеро", type: 2, priceParts: ["550"], volume: "330мл", description: "Без сахара" },
    { id: "arka-bar-0018", name: "Тоник", type: 2, priceParts: ["550"], volume: "330мл", description: "Лёгкая горчинка" },
    { id: "arka-bar-0019", name: "Ред Булл", type: 2, priceParts: ["600"], volume: "250мл", description: "Заряд бодрости" },
    { id: "arka-bar-0020", name: "Ред Булл без сахара", type: 2, priceParts: ["600"], volume: "250мл", description: "Бодрость без сахара" },
  ] },
  ...
  { kind: 'category', sheet: "БА", category: "Классические чаи", items: [
    { id: "arka-bar-0026", name: "Ассам", type: 2, priceParts: ["800"], volume: "800мл", description: "Крепкий, терпкий" },
    { id: "arka-bar-0027", name: "Эрл Грей", type: 2, priceParts: ["800"], volume: "800мл", description: "С бергамотом" },
    { id: "arka-bar-0028", name: "Молочный улун", type: 2, priceParts: ["800"], volume: "800мл", description: "Сливочный, мягкий" },
  ] },
  { kind: 'category', sheet: "БА", category: "Премиальные чаи", items: [
    { id: "arka-bar-0029", name: "Моли чжень ло", type: 2, priceParts: ["1400"], volume: "800мл", description: "Жасминовый зелёный" },
    { id: "arka-bar-0030", name: "Габа", type: 2, priceParts: ["1400"], volume: "800мл", description: "Мягкий, обволакивающий" },
    { id: "arka-bar-0031", name: "Да хун пао", type: 2, priceParts: ["1400"], volume: "800мл", description: "Дымный улун" },
    { id: "arka-bar-0032", name: "Те гуан инь мао ча", type: 2, priceParts: ["1400"], volume: "800мл", description: "Цветочный улун" },
    { id: "arka-bar-0033", name: "Лун Цзин", type: 2, priceParts: ["1400"], volume: "800мл", description: "Свежий, травянистый" },
    { id: "arka-bar-0034", name: "Пуэр выдержанный", type: 2, priceParts: ["1400"], volume: "800мл", description: "Землистый, выдержанный" },
  ] },
  { kind: 'category', sheet: "БА", category: "Тизаны", items: [
    { id: "arka-bar-0035", name: "Таёжный травяной с тибетской ромашкой", type: 2, priceParts: ["1000"], volume: "800мл", description: "Травяной, успокаивающий" },
    { id: "arka-bar-0036", name: "Карельский подкопчённый с ягодами", type: 2, priceParts: ["1000"], volume: "800мл", description: "Дымный, ягодный" },
    { id: "arka-bar-0037", name: "Малина с мятой", type: 2, priceParts: ["1000"], volume: "800мл", description: "Ягодно-мятный" },
    { id: "arka-bar-0038", name: "Гречишный", type: 2, priceParts: ["1000"], volume: "800мл", description: "Тёплый, медовый" },
  ] },
  { kind: 'category', sheet: "БА", category: "Чайные добавки", items: [
    { id: "arka-bar-0039", name: "Свежий тимьян", type: 2, priceParts: ["100"], volume: null, description: "Ароматная добавка" },
    { id: "arka-bar-0040", name: "Листья свежей мяты", type: 2, priceParts: ["100"], volume: null, description: "Освежающая добавка" },
    { id: "arka-bar-0041", name: "Цветы розы", type: 2, priceParts: ["100"], volume: null, description: "Цветочная добавка" },
  ] },
  { kind: 'category', sheet: "БА", category: "Кофе", items: [
    { id: "arka-bar-0042", name: "Двойной эспрессо", type: 2, priceParts: ["400"], volume: "60мл", description: "Насыщенный, бодрящий" },
    { id: "arka-bar-0043", name: "Американо", type: 2, priceParts: ["400"], volume: "200мл", description: "Лёгкий, классический" },
    { id: "arka-bar-0044", name: "Флэт Уайт", type: 2, priceParts: ["550"], volume: "220мл", description: "Бархатистый, сбалансированный" },
    { id: "arka-bar-0045", name: "Капучино", type: 2, priceParts: ["550"], volume: "220мл", description: "Пена + эспрессо" },
    { id: "arka-bar-0046", name: "Латте", type: 2, priceParts: ["600"], volume: "300мл", description: "Мягкий, молочный" },
    { id: "arka-bar-0047", name: "Айс Латте", type: 2, priceParts: ["600"], volume: "300мл", description: "Холодный, молочный" },
    { id: "arka-bar-0048", name: "Раф Кофе", type: 2, priceParts: ["600"], volume: "300мл", description: "Сливочно-ванильный" },
    { id: "arka-bar-0049", name: "Эспрессо Тоник", type: 2, priceParts: ["500"], volume: "300мл", description: "Эспрессо + тоник" },
    { id: "arka-bar-0050", name: "Бамбл Кофе", type: 2, priceParts: ["600"], volume: "300мл", description: "Апельсин + эспрессо" },
    { id: "arka-bar-0051", name: "Какао Карамель", type: 2, priceParts: ["600"], volume: "300мл", description: "Сладкое какао" },
  ] },
  { kind: 'category', sheet: "БА", category: "Добавки", items: [
    { id: "arka-bar-0052", name: "Топпинги сироп/ Кокосовое молоко / Миндальное молоко", type: 2, priceParts: ["150"], volume: null, description: "На выбор" },
  ] },
  { kind: 'category', sheet: "БА", category: "Закуски", items: [
    { id: "arka-bar-0053", name: "Арахис соленый", type: 2, priceParts: ["550"], volume: null, description: "Солёный, к напиткам" },
  ...
  { kind: 'category', sheet: "Алкоголь", category: "Настойки", items: [
    { id: "arka-bar-0071", name: "Манго Маракуйя", type: 2, priceParts: ["1100"], volume: "4*50мл", description: "Тропическая, сладкая" },
    { id: "arka-bar-0072", name: "Ягодный Негрони", type: 2, priceParts: ["1100"], volume: "4*50мл", description: "Горько-ягодная" },
    { id: "arka-bar-0073", name: "Апельсин Юдзу", type: 2, priceParts: ["1100"], volume: "4*50мл", description: "Цитрусовая, яркая" },
    { id: "arka-bar-0074", name: "Слива Голубика", type: 2, priceParts: ["1100"], volume: "4*50мл", description: "Фруктово-терпкая" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Авторские коктейли", items: [
  ...
  { kind: 'category', sheet: "Алкоголь", category: "Игристые и шампанские вина", items: [
    { id: "arka-bar-0083", name: "Бленд Гранд Кюве 1531. Франция. Брют.", type: 2, priceParts: ["1350", "7000"], volume: "150мл / 750мл", description: "Сухое, элегантное" },
    { id: "arka-bar-0084", name: "Просекко Пассапарола. Италия. Брют.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Лёгкое, фруктовое" },
    { id: "arka-bar-0085", name: "Ламбруско Алеотти. Италия. П/сл.", type: 2, priceParts: ["800", "4000"], volume: "150мл / 750мл", description: "Мягкое, ягодное" },
    { id: "arka-bar-0086", name: "Креман Ален Байи Петроний. Франция. Брют.", type: 2, priceParts: ["12000"], volume: "750мл", description: "Свежее, минеральное" },
    { id: "arka-bar-0087", name: "Моёт & Шандон. Франция. Брют.", type: 2, priceParts: ["16500"], volume: "750мл", description: "Изысканная классика" },
    { id: "arka-bar-0088", name: "Бленд Фоллеман Розе. Франция. Брют.", type: 2, priceParts: ["19000"], volume: "750мл", description: "Розовое, ягодное" },
    { id: "arka-bar-0089", name: "Кава Кастель Лорд. Испания. Брют.", type: 2, priceParts: ["5500"], volume: "750мл", description: "Хрустящее, сухое" },
    { id: "arka-bar-0090", name: "Бруни Асти. Италия. Сл.", type: 2, priceParts: ["5500"], volume: "750мл", description: "Сладкое, мускатное" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Белые вина", items: [
    { id: "arka-bar-0091", name: "Шардоне Локо Чимбали. Аргентина. Сух.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Фруктовое, сухое" },
    { id: "arka-bar-0092", name: "Пино Гриджио Прадио Приара. Италия. Сух.", type: 2, priceParts: ["1200", "6000"], volume: "150мл / 750мл", description: "Лёгкое, цитрусовое" },
    { id: "arka-bar-0093", name: "Шенен Блан Симонсиг. ЮАР. П/сух.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Свежее, медовое" },
    { id: "arka-bar-0094", name: "Совиньон Блан Паддл Крик. Новая Зеландия. П/сух.", type: 2, priceParts: ["1200", "6000"], volume: "150мл / 750мл", description: "Травянистое, яркое" },
    { id: "arka-bar-0095", name: "Совиньон Блан Жарден де ля Тор Марсан. Франция. Сух.", type: 2, priceParts: ["3500"], volume: "750мл", description: "Свежее, минеральное" },
    { id: "arka-bar-0096", name: "Шардоне Ле Гран Нуар. Франция. Сух.", type: 2, priceParts: ["5000"], volume: "750мл", description: "Маслянистое, сбалансированное" },
    { id: "arka-bar-0097", name: "Шардоне Жан-Марк Брокар Шабли. Франция. Сух.", type: 2, priceParts: ["12000"], volume: "750мл", description: "Минеральное, элегантное" },
    { id: "arka-bar-0098", name: "Пфефферер. Италия. П/сух.", type: 2, priceParts: ["5900"], volume: "750мл", description: "Ароматное, пряное" },
    { id: "arka-bar-0099", name: "Вердехо Маркиз де Рискаль. Испания. Сух.", type: 2, priceParts: ["6500"], volume: "750мл", description: "Свежее, травяное" },
    { id: "arka-bar-0100", name: "Рислинг Ник Вайс. Германия. П/сух.", type: 2, priceParts: ["8000"], volume: "750мл", description: "Фруктовое, живое" },
    { id: "arka-bar-0101", name: "Грюнер Вельтлинер Настл. Австрия. Сух.", type: 2, priceParts: ["6000"], volume: "750мл", description: "Пряное, минеральное" },
    { id: "arka-bar-0102", name: "Шардоне Виньярдс. Аргентина. Сух.", type: 2, priceParts: ["3400"], volume: "750мл", description: "Мягкое, фруктовое" },
    { id: "arka-bar-0103", name: "Рислинг Галицкий. Россия. Сух.", type: 2, priceParts: ["7500"], volume: "750мл", description: "Свежее, цитрусовое" },
    { id: "arka-bar-0104", name: "Каберне Совиньон Старая дорога на Джанхот. Россия. Сух.", type: 2, priceParts: ["7000"], volume: "750мл", description: "Насыщенное, сухое" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Розовые вина", items: [
    { id: "arka-bar-0105", name: "Бленд Фламинго Николаев и сыновья. Россия. Сух.", type: 2, priceParts: ["850", "4250"], volume: "150мл / 750мл", description: "Свежее, ягодное" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Красные вина", items: [
    { id: "arka-bar-0106", name: "Пино Нуар Ле Гран Нуар. Франция. П/сух.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Лёгкое, ягодное" },
    { id: "arka-bar-0107", name: "Мальбек Луиджи Боска. Аргентина. Сух.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Насыщенное, сливовое" },
    { id: "arka-bar-0108", name: "Примитиво Примосоле. Италия. П/сух.", type: 2, priceParts: ["1100", "5000"], volume: "150мл / 750мл", description: "Пряное, тёмно-ягодное" },
    { id: "arka-bar-0109", name: "Бленд Петрикор Шумринка. Россия. Сух.", type: 2, priceParts: ["1100", "5500"], volume: "150мл / 750мл", description: "Насыщенное, бархатистое" },
    { id: "arka-bar-0110", name: "Жарден де ля Тор Гренаш Сира. Франция. П/сух.", type: 2, priceParts: ["3500"], volume: "750мл", description: "Пряное, фруктовое" },
    { id: "arka-bar-0111", name: "Санджовезе Нипоццано Кьянти Руфина. Италия. Сух.", type: 2, priceParts: ["9000"], volume: "750мл", description: "Терпкое, вишнёвое" },
    { id: "arka-bar-0112", name: "Темпранильо Матсу Эль Пикаро. Испания. Сух.", type: 2, priceParts: ["5500"], volume: "750мл", description: "Насыщенное, дубовое" },
    { id: "arka-bar-0113", name: "Пино Нуар Каролина Ресерва. Чили. Сух.", type: 2, priceParts: ["3500"], volume: "750мл", description: "Лёгкое, элегантное" },
    { id: "arka-bar-0114", name: "Карменер Селлар Селекшн. Чили. П/сух.", type: 2, priceParts: ["3000"], volume: "750мл", description: "Мягкое, перечное" },
    { id: "arka-bar-0115", name: "Шираз Теннесити Макларен. Австралия. Сух.", type: 2, priceParts: ["7500"], volume: "750мл", description: "Насыщенное, пряное" },
    { id: "arka-bar-0116", name: "Зинфандель Краб&Мо. США. П/сух.", type: 2, priceParts: ["5500"], volume: "750мл", description: "Сладковатое, ягодное" },
    { id: "arka-bar-0117", name: "Каберне Фран Южная Вертикаль. Россия. Сух.", type: 2, priceParts: ["7000"], volume: "750мл", description: "Терпкое, травяное" },
    { id: "arka-bar-0118", name: "Бленд Красная книга Глава 2 Скалистый берег. Россия. Сух.", type: 2, priceParts: ["7000"], volume: "750мл", description: "Насыщенное, плотное" },
  ] },
  { kind: 'header', sheet: "Алкоголь", title: "Крепкий алкоголь" },
  { kind: 'category', sheet: "Алкоголь", category: "Аперетивы / Биттеры / Ликёры", items: [
    { id: "arka-bar-0119", name: "Мартини Бьянко. Италия.", type: 2, priceParts: ["600"], volume: "100мл", description: "Сладкий вермут" },
    { id: "arka-bar-0120", name: "Мартини Россо. Италия.", type: 2, priceParts: ["600"], volume: "100мл", description: "Пряный вермут" },
    { id: "arka-bar-0121", name: "Мартини Фиеро. Италия.", type: 2, priceParts: ["600"], volume: "100мл", description: "Апельсиновый вермут" },
    { id: "arka-bar-0122", name: "Апероль. Италия.", type: 2, priceParts: ["600"], volume: "50мл", description: "Горько-сладкий, цитрусовый" },
    { id: "arka-bar-0123", name: "Сарти Роза. Италия.", type: 2, priceParts: ["600"], volume: "50мл", description: "Розовый, ягодный" },
    { id: "arka-bar-0124", name: "Бэйлис. Ирландия.", type: 2, priceParts: ["650"], volume: "50мл", description: "Сливочный ликёр" },
    { id: "arka-bar-0125", name: "Ягермейстер. Германия.", type: 2, priceParts: ["650"], volume: "50мл", description: "Травяной биттер" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Текила", items: [
    { id: "arka-bar-0126", name: "Эль Текиленьо Бланко. Мексика.", type: 2, priceParts: ["750"], volume: "50мл", description: "Чистый вкус агавы" },
    { id: "arka-bar-0127", name: "Эль Текиленьо Репосадо. Мексика.", type: 2, priceParts: ["850"], volume: "50мл", description: "Мягкий, выдержанный" },
    { id: "arka-bar-0128", name: "Хосе Куэрво 1800 Бланко. Мексика.", type: 2, priceParts: ["850"], volume: "50мл", description: "Классика, агава" },
    { id: "arka-bar-0129", name: "Сенот Бланко. Мексика.", type: 2, priceParts: ["1250"], volume: "50мл", description: "Свежий, минеральный" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Джин", items: [
    { id: "arka-bar-0130", name: "Бомбей Сапфир. Великобритания.", type: 2, priceParts: ["850"], volume: "50мл", description: "Можжевеловый, ботанический" },
    { id: "arka-bar-0131", name: "Бифитер. Великобритания.", type: 2, priceParts: ["600"], volume: "50мл", description: "Классический лондонский" },
    { id: "arka-bar-0132", name: "Уитли Нейлл Розовый Грейпфрут. Великобритания.", type: 2, priceParts: ["700"], volume: "50мл", description: "Грейпфрутовый, яркий" },
    { id: "arka-bar-0133", name: "Уитли Нейлл Юдзу Белая клубника. Великобритания.", type: 2, priceParts: ["700"], volume: "50мл", description: "Юдзу и клубника" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Ром", items: [
    { id: "arka-bar-0134", name: "Такамака Бланко. Сейшельские острова.", type: 2, priceParts: ["650"], volume: "50мл", description: "Лёгкий, свежий" },
    { id: "arka-bar-0135", name: "Такамака Дарк Спайсд. Сейшельские острова.", type: 2, priceParts: ["650"], volume: "50мл", description: "Пряный, тёмный" },
    { id: "arka-bar-0136", name: "Такамака Экстра Ноир. Сейшельские острова.", type: 2, priceParts: ["800"], volume: "50мл", description: "Насыщенный, карамельный" },
    { id: "arka-bar-0137", name: "Дипломатико Ботукал. Венесуэла.", type: 2, priceParts: ["1200"], volume: "50мл", description: "Мягкий, ванильный" },
    { id: "arka-bar-0138", name: "Закапа 23 года. Гватемала.", type: 2, priceParts: ["1700"], volume: "50мл", description: "Выдержанный, сладкий" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Коньяк", items: [
    { id: "arka-bar-0139", name: "Хеннесси VS. Франция.", type: 2, priceParts: ["1250"], volume: "50мл", description: "Молодой, фруктовый" },
    { id: "arka-bar-0140", name: "Хеннесси VSOP. Франция.", type: 2, priceParts: ["1700"], volume: "50мл", description: "Выдержанный, дубовый" },
    { id: "arka-bar-0141", name: "Хеннесси XO. Франция.", type: 2, priceParts: ["5500"], volume: "50мл", description: "Насыщенный, долгое послевкусие" },
    { id: "arka-bar-0142", name: "Эйч бай Хайн VSOP. Франция.", type: 2, priceParts: ["1350"], volume: "50мл", description: "Мягкий, пряный" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Виски односолодовый", items: [
    { id: "arka-bar-0143", name: "Гленфиддик 12 лет. Шотландия.", type: 2, priceParts: ["1350"], volume: "50мл", description: "Грушево-медовый" },
    { id: "arka-bar-0144", name: "Макаллан Дабл Каск 12 лет. Шотландия.", type: 2, priceParts: ["2500"], volume: "50мл", description: "Ванильно-карамельный" },
    { id: "arka-bar-0145", name: "Макаллан Дабл Каск 18 лет. Шотландия.", type: 2, priceParts: ["6500"], volume: "50мл", description: "Насыщенный, выдержанный" },
    { id: "arka-bar-0146", name: "Абер Фоллс Сингл Молт Мадейра Каск. Великобритания.", type: 2, priceParts: ["900"], volume: "50мл", description: "Фруктово-сладкий" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Виски купажированный", items: [
    { id: "arka-bar-0147", name: "Чивас Регал 12 лет. Шотландия.", type: 2, priceParts: ["1300"], volume: "50мл", description: "Мягкий, медовый" },
    { id: "arka-bar-0148", name: "Баллантайнс. Шотландия.", type: 2, priceParts: ["650"], volume: "50мл", description: "Лёгкий, сбалансированный" },
    { id: "arka-bar-0149", name: "Джэмисон. Ирландия.", type: 2, priceParts: ["800"], volume: "50мл", description: "Мягкий ирландский" },
    { id: "arka-bar-0150", name: "Джим Бим. США.", type: 2, priceParts: ["750"], volume: "50мл", description: "Классический бурбон" },
    { id: "arka-bar-0151", name: "Джек Дэниелс. США.", type: 2, priceParts: ["850"], volume: "50мл", description: "Дымно-карамельный" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Водка", items: [
    { id: "arka-bar-0152", name: "Онегин. Россия.", type: 2, priceParts: ["600"], volume: "50мл", description: "Чистая, мягкая" },
    { id: "arka-bar-0153", name: "Белуга. Россия.", type: 2, priceParts: ["600"], volume: "50мл", description: "Премиальная классика" },
    { id: "arka-bar-0154", name: "Мамонт. Россия.", type: 2, priceParts: ["600"], volume: "50мл", description: "Мягкая, чистая" },
  ] },
  { kind: 'category', sheet: "Алкоголь", category: "Пиво", items: [
    { id: "arka-bar-0155", name: "Францесканер. Россия.", type: 2, priceParts: ["700"], volume: "500мл", description: "Пшеничное, лёгкое" },
    { id: "arka-bar-0156", name: "Шпатен. Россия.", type: 2, priceParts: ["700"], volume: "500мл", description: "Классический лагер" },
    { id: "arka-bar-0157", name: "Аббе Брюн. Россия.", type: 2, priceParts: ["700"], volume: "500мл", description: "Тёмное, солодовое" },
    { id: "arka-bar-0158", name: "Корона Экстра. Мексика.", type: 2, priceParts: ["700"], volume: "330мл", description: "Лёгкое, с лаймом" },
    { id: "arka-bar-0159", name: "Стелла Артуа (б/а). Россия.", type: 2, priceParts: ["650"], volume: "440мл", description: "Безалкогольный лагер" },
  ] },
];
