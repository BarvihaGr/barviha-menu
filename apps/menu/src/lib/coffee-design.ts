...
const KIEV_PALETTE: CoffeePalette = {
  ...
  '--cm-text': '#3C2210',
  '--cm-text-soft': '#6B4A28',
  // Контраст поднят повторно 2026-08-03: даже 0.80/0.65 (~5.8:1/~3.9:1) не
  // хватало для мелких подписей («Состав», «КБЖУ», 11px) — WCAG AA для
  // некрупного текста требует 4.5:1, а 3.9:1 был ниже. 0.85/0.75 дают
  // ~6.6:1/~5.1:1 — с запасом выше порога.
  '--cm-muted': 'rgba(60, 34, 16, 0.85)',
  '--cm-muted-dim': 'rgba(60, 34, 16, 0.75)',
...
const ARKA_PALETTE: CoffeePalette = {
  ...
  '--cm-text': '#3C2210',
  '--cm-text-soft': '#6B4A28',
  // Контраст поднят повторно 2026-08-03: см. тот же комментарий в KIEV_PALETTE.
  '--cm-muted': 'rgba(60, 34, 16, 0.85)',
  '--cm-muted-dim': 'rgba(60, 34, 16, 0.75)',
  '--cm-border': 'rgba(140, 101, 64, 0.18)',
  '--cm-logo-invert': '0',
