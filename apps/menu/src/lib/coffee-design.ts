...
const KIEV_PALETTE: CoffeePalette = {
  ...
  '--cm-text': '#3C2210',
  '--cm-text-soft': '#6B4A28',
  // Контраст поднят 2026-08-03: при 0.52/0.36 текст состава и подписи
  // («Состав», «КБЖУ») почти сливались с фоном карточки (~2.5:1/~1.9:1 —
  // ниже порога WCAG AA даже для крупного текста). 0.80/0.65 дают ~4.6:1/~3.3:1.
  '--cm-muted': 'rgba(60, 34, 16, 0.80)',
  '--cm-muted-dim': 'rgba(60, 34, 16, 0.65)',
...
const ARKA_PALETTE: CoffeePalette = {
  ...
  '--cm-text': '#3C2210',
  '--cm-text-soft': '#6B4A28',
  // Контраст поднят 2026-08-03: см. тот же комментарий в KIEV_PALETTE.
  '--cm-muted': 'rgba(60, 34, 16, 0.80)',
  '--cm-muted-dim': 'rgba(60, 34, 16, 0.65)',
  '--cm-border': 'rgba(140, 101, 64, 0.18)',
  '--cm-logo-invert': '0',
