...
const BAR_CATEGORY_TR: Record<string, { en: string; zh: string; hy: string }> = {
  ...
  'Крепленые вина': { en: 'Fortified Wines', zh: '加烈葡萄酒', hy: 'Ամրապնդված գինիներ' },
  Граппа: { en: 'Grappa', zh: '格拉巴酒', hy: 'Գրապա' },
  'Саке и соджу': { en: 'Sake & Soju', zh: '清酒與燒酒', hy: 'Սակե և սոջու' },
  'Цветочные чаи': { en: 'Flower Teas', zh: '花茶', hy: 'Ծաղկային թեյեր' },
  'Холодные чаи': { en: 'Iced Teas', zh: '冰茶', hy: 'Սառը թեյեր' },
};
